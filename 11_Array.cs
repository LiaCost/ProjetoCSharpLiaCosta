...
namespace Curso_CSharp
{
    public class Array
    {
        public static void DemonstrarArray()
        {
            ...
            string[] diasDaSemana = { "Domingo", "Segunda-Feira", "Terça-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "Sabádo" }; // Array de strings
            ...
            // 3. Acesso aos Elementos ao Array
            ...
            {
                Console.WriteLine($"Elemento {i} do array números: {numeros[i]}");
            }
            ...
            Console.WriteLine($"Elemnento [0][1] do jaggedArray: {jaggedArray[0][1]}");
            Console.WriteLine($"Elemnento [2][3] do jaggedArray: {jaggedArray[2][3]}");
